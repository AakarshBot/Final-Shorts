...
- headline uses the bundled Oswald Bold block display face, dynamically fitted to one or two lines with a hard minimum size, with a moving blue/yellow brand marker
