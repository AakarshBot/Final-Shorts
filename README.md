...
- **Headline:** large Oswald Bold block display face, single line, dynamically fitted to the safe width, with the existing left-entry animation and moving blue/yellow brand marker.
